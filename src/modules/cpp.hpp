...
namespace handlers {
    ...
    private:
        ...
        void compile() override {
            ...
            const std::string command = compile_command + ' ' + standard + ' ' + default_args + ' ' + work_dir + "/main.cpp";
    ...
    public:
        Cpp(data::Submission submission, data::Problem problem) : IModules(std::move(submission), std::move(problem)) {}
    };
